...
return [
    ...
    'title' => 'Localizador de Editais API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Documentação dos endpoints da API do Localizador de Editais.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Envie o token JWT retornado pelo endpoint de login no cabeçalho <code>Authorization: Bearer {YOUR_JWT_TOKEN}</code>.',
    ],
